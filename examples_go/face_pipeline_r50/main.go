// Face detection + recognition using ArcFace ResNet50 (w600k_r50.onnx).
//
// Build & run:
//
...
func main() {
	...
	recognizerPath := flag.String("recognizer", "w600k_r50.onnx", "path to ArcFace ResNet50 ONNX model")
